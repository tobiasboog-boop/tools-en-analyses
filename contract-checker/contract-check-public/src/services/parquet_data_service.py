...
class ParquetDataService:
    ...
    def _load_data(self):
        ...
        self.df_opbrengsten = pd.read_parquet(self.data_dir / "opbrengsten.parquet")
    ...
    def _build_indices(self):
        ...
        self._opbrengsten_by_paragraaf = self.df_opbrengsten.groupby("werkbonparagraaf_key")
    ...
    def get_werkbon_keten(
        ...
        for werkbon in werkbonnen:
            ...
            for _, p_row in paragrafen_df.iterrows():
                ...
                totaal_opbrengsten = 0.0
                try:
                    opbr_df = self._opbrengsten_by_paragraaf.get_group(paragraaf_key)
                    totaal_opbrengsten = opbr_df["bedrag"].sum()
                except KeyError:
                    pass
                ...
                paragraaf = WerkbonParagraaf(
                    ...
                    totaal_opbrengsten=float(totaal_opbrengsten)
                )
                ...
                if include_opbrengsten_details:
                    self._load_opbrengsten_details(paragraaf)
    ...
    def _load_opbrengsten_details(self, paragraaf: WerkbonParagraaf):
        """Load opbrengsten details for a paragraaf."""
        try:
            opbr_df = self._opbrengsten_by_paragraaf.get_group(paragraaf.werkbonparagraaf_key)
        except KeyError:
            return
        ...
        for _, o_row in opbr_df.iterrows():
            ...
            paragraaf.opbrengsten.append(opbrengst_regel)
